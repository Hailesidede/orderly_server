...
public class PaymentServiceImpl implements PaymentService {
    ...
    public void processTransactionalUpdate(MpesaCallbackResponse.StkCallback stkCallback) {
        ...
        if (resultCode != 0) {
            ...
            paymentSseService.notifyPaymentResult(checkoutRequestId, "FAILED", stkCallback.resultDesc());
        ...
        paymentSseService.notifyPaymentResult(checkoutRequestId, "SUCCESS", "Payment received successfully.");
